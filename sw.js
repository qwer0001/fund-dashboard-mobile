const CACHE='fund-dashboard-mobile-v2.3.8-hide-cleared-private-history-30';
const ASSETS=['./','./index.html','./styles.css?v=2.3.8','./app.js?v=2.3.8','./manifest.webmanifest','./icons/icon-192.png','./icons/icon-512.png'];
