const CACHE='fund-dashboard-mobile-v2.3.6-trusted-device-private-history-30';
const ASSETS=['./','./index.html','./styles.css?v=2.3.6','./app.js?v=2.3.6','./manifest.webmanifest','./icons/icon-192.png','./icons/icon-512.png'];
