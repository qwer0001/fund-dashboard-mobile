const CACHE='fund-dashboard-mobile-v2.3.5-once-login-private-history-30';
const ASSETS=['./','./index.html','./styles.css?v=2.3.5','./app.js?v=2.3.5','./manifest.webmanifest','./icons/icon-192.png','./icons/icon-512.png'];
