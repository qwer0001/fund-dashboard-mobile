const CACHE='fund-dashboard-mobile-v2.4.2-trade-track-fix-private-history-30';
const ASSETS=['./','./index.html','./styles.css?v=2.4.2','./app.js?v=2.4.2','./manifest.webmanifest','./icons/icon-192.png','./icons/icon-512.png'];
